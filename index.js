...
// // Q: What is the space complexity of this function?
// // ANSWER: ANSWER: O(n^2) Polynomial
...
// // Still O(n) Linear, but it is only n rather than 2n with the copy of the numbers array being made and stored in numbers2 variable
...
// // ANSWER - countLetters: O(n) Linear
// // ANSWER - countLettersRoundTwo: O(n) Linear


// // Q: Explain how you came to your conclusions about the space complexity of each function. 
// // ANSWER: Each function initiates an empty object, and performs a single loop through the split string and does a count incrementation with each loop iteration, therefore are completely dependent on the size of the string
...
class Naruto {
  ...
  carModel(make){
    if (this.cache.hasOwnProperty(make)){
      return this.cache[make]
    }
    let models
    switch (make){
      case 'Honda':
        models = ['Civic', 'Accord', 'Pilot', 'Ridgeline']
        this.cache[make] = models
        break;
      case 'Toyota':
        models = ['Carolla', 'Camry', 'Tacoma', 'Prius']
        this.cache[make] = models
        break;
      case 'Ford':
        models = ['Raptor', 'Focus', 'Explorer', 'Mustang']
        this.cache[make] = models
        break;
      case 'Dodge':
        models = ['Ram', 'Durango', 'Charger', 'Challenger']
        this.cache[make] = models
        break;
      case 'Chevy':
        models = ['Camaro', 'Cruze', 'Silverado', 'Suburban']
        this.cache[make] = models
        break;
      default:
        models = ['Sorry, No Models Found']
        this.cache[make] = models
        break;
    }
    return models 
...
// ANSWER: I think the Cached version will run much faster

// Now fill this out and run your file

// CREATE A NEW INSTANCE OF YOUR CLASS
const hokage = new Naruto()

console.time("not memoized function time");
console.log(carModelNoCache('Chevy'))
console.log(carModelNoCache('Chevy'))
console.log(carModelNoCache('Chevy'))
console.log(carModelNoCache('Chevy'))
console.log(carModelNoCache('Toyota'))
console.log(carModelNoCache('Toyota'))
console.log(carModelNoCache('Toyota'))
console.log(carModelNoCache('Toyota'))
console.log(carModelNoCache('Honda'))
console.log(carModelNoCache('Honda'))
console.log(carModelNoCache('Honda'))
console.log(carModelNoCache('Honda'))
console.log(carModelNoCache('Ford'))
console.log(carModelNoCache('Ford'))
console.log(carModelNoCache('Ford'))
console.log(carModelNoCache('Ford'))
...
console.log(hokage.carModel('Chevy'))
console.log(hokage.carModel('Chevy'))
console.log(hokage.carModel('Toyota'))
console.log(hokage.carModel('Toyota'))
console.log(hokage.carModel('Honda'))
console.log(hokage.carModel('Honda'))
console.log(hokage.carModel('Ford'))
console.log(hokage.carModel('Ford'))
console.log(hokage.carModel('Chevy'))
console.log(hokage.carModel('Chevy'))
console.log(hokage.carModel('Toyota'))
